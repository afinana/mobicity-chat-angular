...
/**
 * @ngdoc function
 * @name chatAngularApp.controller:SocketcontrollerCtrl
 * @description
 * # SocketcontrollerCtrl
 * Controller of the chatAngularApp
 */
 angular.module('chatAngularApp')
 .controller('SocketCtrl', function ($log, $scope, chatSocket, 
